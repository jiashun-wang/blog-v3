...
export default defineAppConfig({
	...
	footer: {
		...
		iconNav: [
			...
			{ icon: 'ri:qq-line', text: '交流群: 198710392', url: 'https://jq.qq.com/?_wv=1027&k=lQfNSeEd' },
			{ icon: 'tabler:brand-github', text: 'GitHub: chum-bucket-site', url: 'https://github.com/chum-bucket-site' },
		...
		nav: [
			...
			// 	title: '社交',
			// 	items: [
			// 		{ icon: 'tabler:brand-github', text: 'chum-bucket-site', url: 'https://github.com/L33Z22L11' },
			// 		{ icon: 'ri:qq-line', text: '群: 198710392', url: 'https://jq.qq.com/?_wv=1027&k=lQfNSeEd' },
			...
			// },
			{
				...
				items: [
					...
					{ icon: 'tabler:certificate', text: '苏ICP备2023101667号', url: 'https://beian.miit.gov.cn/' },
					{ icon: 'https://beian.mps.gov.cn/img/logo01.dd7ff50e.png', text: '苏公网安备32128102010386号', url: 'https://beian.miit.gov.cn/' },
	...
	/** 左侧栏顶部 Logo */
	header: {
		logo: 'https://cdn.chum-bucket.site/image/20251006-175239-849.webp',
		/** 展示标题文本，否则展示纯 Logo */
		showTitle: true,
